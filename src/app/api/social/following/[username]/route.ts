/**
 * GET /api/social/following/[username]?page=0
 * Paginated list of students [username] follows. Private profiles return
...
export async function GET(request: NextRequest, context: RouteContext) {
  try {
    ...
    return socialJson(await listFollowing(username, ctx.userId, page));
  } catch (error) {
