...
const FLAG_SPECS: Record<FlagKey, FlagSpec> = {
  ...
  questionBag:       { envSuffix: "QUESTION_BAG",        defaultDev: false, defaultProd: false },
  teacherTests:      { envSuffix: "TEACHER_TESTS",       defaultDev: false, defaultProd: false },
  teacherRooms:      { envSuffix: "TEACHER_ROOMS",       defaultDev: false, defaultProd: false },
